...
<div class="row clearfix">
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="header">
                <h2><strong>List des</strong> Villes </h2>
                <div class="">
                    <form class="d-inline" action="{{route('ville.create')}}" > 
                        <button class="btn btn-primary  btn-animated btn-animated-y">
                            <span class="btn-inner--visible">Ajouter Ville</span>
                    ...
                    <table class="table table-striped table-hover js-basic-example dataTable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <form  class="d-inline"  action="{{url ('admin/ville/'.$ville->id.'/edit')}}" method="get"> 
                                        <button  type="submit" class="btn btn-warning inline">Modifier</button>
                                    </form>
                                     <form class="d-inline" action="{{url ('admin/ville/'. $ville->id)}}" method="POST"> 
                                        @method('DELETE')
                                        @csrf()
