    ...
    <div class="left_sidebar">
        <nav class="sidebar">
            ...
            <ul id="main-menu" class="metismenu">
                ...
                <li class="@if(isset($reseau) == true) active @else  @endif"><a href="{{url('admin/reseaux')}}"><i class="fa fa-rss-square"></i><span>Reseau sociaux</span></a></li>
                ...
                <li class="@if(isset($langue) == true) active @else  @endif"><a href="{{url('admin/languee')}}"><i class="fa fa-bookmark-o"></i><span>Langues</span></a></li>
