                    ...
                    <form    action="{{route('experience.update',$id)}}" method="post"  enctype="multipart/form-data" >
                        ...
                        <div class="row">
                            ...
                            <div class="form-group  col-lg-6">
                                ...
                                <input type="date" class="form-control" value="{{$exp->dateDebutEx}}"  name="dateDebutEx" required>
                                @error('dateDebutEx')
                                    <strong>{{ $message }}</strong>
                                @enderror
                            </div>
                            <div class="form-group  col-lg-6">
                                ...
                                <input type="date" class="form-control" value="{{$exp->dateFinEx}}" name="dateFinEx" required>
                                @error('dateFinEx')
                                    <strong>{{ $message }}</strong>
                                @enderror
                            </div>
